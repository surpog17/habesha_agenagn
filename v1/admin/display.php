...
if(isset($_GET['did']))
{
  ...
  $deleteq =    mysqli_query($con, "delete from tbl_product where pro_id ='{$did}'") or die(mysqli_error($con));
...
$selectq = mysqli_query($con 'SELECT * FROM `electronics`') or die(mysqli_error($con));
